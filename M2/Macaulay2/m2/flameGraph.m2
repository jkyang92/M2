-- Copyright 2026 by Claude Code (and Mahrud Sayrafi and Luke and Rosie and Jay)

-- flameGraph and installFlameGraph: render an SVG flame chart from
-- ProfileTable data collected by 'profile' (see profile.m2).
